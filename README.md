...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.18.0-orange.svg" alt="Version">
...
- **On-device inference** — BirdNET+ model (10,208 species), no internet required
...
- `BirdNET+_Geomodel_V3.0.3_Global_10K-pruned_FP16.onnx` — location-based species model (~13 MB)

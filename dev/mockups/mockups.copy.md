# BirdNET Live Store Mockup Copy

Edit titles and subtitles here. Run `node sync-copy.js` to update the browser preview, or run `node render-mockups.js` to sync and export in one step.

Supported slide IDs: `menu`, `live`, `review`, `explore`, `species`, `files`.

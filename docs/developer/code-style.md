...
- All user-facing strings go in every UI locale ARB file: `app_en.arb`, `app_de.arb`, `app_cs.arb`, `app_es.arb`, `app_fr.arb`, `app_it.arb`, `app_pt.arb`, `app_nl.arb`, `app_nb.arb`, `app_pl.arb`, and `app_ru.arb`.

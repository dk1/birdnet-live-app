...
| Snapshot počasí (volitelný) | Jednorázový záznam teploty, srážek, větru, oblačnosti a kódu počasí na relaci, když je **Povolit vyhledávání počasí** zapnuto | Databáze SQLite |
...
**Odvolání:** kteroukoli ze tří služeb můžete kdykoliv vypnout v **Nastavení → Soukromí**. Již uložené názvy míst a snapshoty počasí zůstávají u relací, kde byly zachyceny; pokud chcete odstranit i tato historická data, použijte **Nastavení → Nebezpečná zóna → Vymazat všechna data**.

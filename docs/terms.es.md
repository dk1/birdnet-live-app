...
Este documento rige el uso de la aplicación BirdNET Live y sus modelos agrupados. 

## 1. Descripción y 2. Licencia
App licenciada bajo MIT.
Modelos basados en Kahl et al. (2021) y licenciados bajo CC BY-SA 4.0. Las restricciones de la sección 5 prevalecen.

## 3. Sin Garantía
SOFTWARE PROPORCIONADO "TAL CUAL", SIN NINGUNA GARANTÍA.

## 4. Responsabilidad
El usuario asume la responsabilidad del cumplimiento normativo y ético de conservación. Las predicciones son probabilísticas, no absolutas.

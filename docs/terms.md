...
The application source code is licensed under the MIT License (see [LICENSE](https://github.com/birdnet-team/birdnet-live-app/blob/main/LICENSE)).
...
For permissions, clarifications, or to report misuse: [stefan.kahl@cornell.edu](mailto:stefan.kahl@cornell.edu)

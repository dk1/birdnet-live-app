...
## Licença e Condições
O código Flutter possui Licença MIT. Modelos (Kahl et al.) possuem Licença CC BY-SA 4.0.

## Isenção de Responsabilidade
Cuidado natural com precisões IA (falsos positivos/negativos). PRODUTO ENTREGUE "COMO ESTÁ".

## USO ESTRITAMENTE PROIBIDO
Qualquer versão ou derivação do BirdNET Live é terminantemente nula se utilizada para:
1. **CAÇA ILEGAL** de animais.
2. **FINS MILITARES**.

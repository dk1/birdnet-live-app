...
Esta página explica los controles y símbolos recurrentes utilizados en BirdNET Live. Las etiquetas debajo coinciden con los controles que ya están presentes en la aplicación.
...
| :esquema-círculo-alerta-material: **Error** | Error de modelo o procesamiento. |
...
| :material-map-marker: **Tiene ubicación** | Confirme una ubicación, muestre coordenadas o etiquete una sesión mapeada. |
| :material-refresh: **Actualizar** | Vuelva a leer la ubicación actual o actualice una lista de predicciones. |
| :material-map: **Selector de mapas** | Elija coordenadas en el selector de mapas. |
| :calendario-material: **Fecha** | Establecer o mostrar una fecha. |
| :material-close: **Borrar** | Eliminar una fecha seleccionada. |
...
## Barra de herramientas de revisión de sesión
...
La barra de información de Live utiliza :material-information-outline: seguido de etiquetas compactas como:

- `now`: detecciones actualmente visibles en la lista en vivo
- `spp` — recuento de especies únicas
...
Si no está seguro de lo que hace un control, abra la hoja de ayuda más cercana en la aplicación o consulte la página de flujo de trabajo para esa pantalla en esta guía del usuario.

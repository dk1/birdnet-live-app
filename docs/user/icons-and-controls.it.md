...
Questa pagina spiega i controlli e i simboli ricorrenti utilizzati in BirdNET Live. Le etichette sottostanti corrispondono ai controlli già presenti nell'app.
...
| :material-alert-circle-outline: **Errore** | Errore di modello o di elaborazione. |
...
| :material-map-marker: **Ha una posizione** | Conferma una posizione, mostra le coordinate o etichetta una sessione mappata. |
| :material-refresh: **Aggiorna** | Rileggi la posizione corrente o aggiorna un elenco di previsioni. |
| :material-map: **Selettore mappa** | Scegli le coordinate dal selettore mappa. |
| :calendario-materiale: **Data** | Imposta o visualizza una data. |
| :material-close: **Cancella** | Rimuovi una data selezionata. |
...
## Barra degli strumenti di revisione della sessione
...
La barra delle informazioni in tempo reale utilizza :material-information-outline: seguito da etichette compatte come:

- `now`: rilevamenti attualmente visibili nell'elenco live
- `spp`: conteggio delle specie uniche
- "det" — rilevamenti totali
...
Se non sei sicuro di cosa fa un controllo, apri il foglio della Guida più vicino nell'app o controlla la pagina del flusso di lavoro per quella schermata in questa guida per l'utente.

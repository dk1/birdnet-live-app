...
Especies previstas para la ubicación y temporada actuales, además de los detalles de las especies superpuestos.

### [Biblioteca de sesiones](session-library.md)

Sesiones guardadas, búsqueda, clasificación, modos de visualización y navegación agrupada por especie.

### [Revisión de sesión](session-review.md)
...
Respuestas rápidas sobre el uso sin conexión, el comportamiento de grabación, el recuento de puntos y el rendimiento.
...
En dispositivos móviles, la barra lateral de navegación está oculta detrás del botón de menú en la esquina superior izquierda. Esta página está destinada a ser el punto de entrada móvil a toda la guía del usuario.
